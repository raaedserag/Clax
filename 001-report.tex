...
\begin{document}
  \begin{mrs-doc-tanta}
   ...
   \tableofcontents
    ...
    % Main matter
    \include{003-introduction}
    \cleardoublepage%
    
    \include{004-System-overview}
    \cleardoublepage%

    \include{005-mobile-app}
     \cleardoublepage%
    
     \include{006-chapter-4}
     \cleardoublepage%
     
     \include{007-admin-panel}
     \cleardoublepage%
     
     \include{008-Conclusion-and-Future-Work}
     \cleardoublepage%
